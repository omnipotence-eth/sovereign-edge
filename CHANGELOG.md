...
### Changed
- `packages/search/src/search/jobs.py`: Retooled for junior/entry-level — Adzuna now runs 8 parallel queries focused on entry-level: "junior data scientist", "entry level machine learning", "data scientist", "machine learning engineer", "AI engineer", "data analyst AI", "data engineer", "MLOps engineer". Title filter expanded with "data analyst", "junior", "associate", "entry level". The Muse and Remotive kept as supplementary (consistently return 0 for ML/AI niche).
